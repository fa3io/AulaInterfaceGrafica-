...
public class ComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Selecione Seu Estado Civil"));

        cbEstadoCivil.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione", "Casado", "Solteiro", "Divorciado", "Viuvo", "Enrolado", " " }));
    ...
    private void cbEstadoCivilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbEstadoCivilActionPerformed
        String selecao = (String) cbEstadoCivil.getSelectedItem();
        
         JOptionPane.showMessageDialog(null, "Item Selecionado: "+ selecao, "Escolha de Sexo", JOptionPane.INFORMATION_MESSAGE);
